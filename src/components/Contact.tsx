...
import { MagicBentoCard, GlobalSpotlight, useMobileDetection } from "./MagicBento";
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="d2c_gradient_tl py-20 lg:py-28 relative contact-section" aria-label="Contact Us">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mt-10">
          {/* Contact Info */}
          <div className="lg:col-span-4 space-y-4" ref={gridRef}>
            <MagicBentoCard
              disableAnimations={shouldDisableAnimations}
              glowColor="44, 203, 153"
              enableTilt={true}
