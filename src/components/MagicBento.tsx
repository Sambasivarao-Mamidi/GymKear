...
const DEFAULT_GLOW_COLOR = "44, 203, 153";
...
const updateCardGlowProperties = (card: HTMLElement, glow: number, radius: number) => {
...
export function GlobalSpotlight({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const section = gridRef.current.closest(".contact-section");
      ...
      cards.forEach((card) => {
        ...
        updateCardGlowProperties(cardElement, glowIntensity, spotlightRadius);
      });
